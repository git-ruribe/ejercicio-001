...
class Pronostico(models.Model):
    ...
    scoreLocal_int = models.IntegerField(null=True, blank=True)
    scoreVisita_int = models.IntegerField(null=True, blank=True)
    pctLocal_int = models.IntegerField(null=True, blank=True)
    pctEmpte_int = models.IntegerField(null=True, blank=True)
    pctVisita_int = models.IntegerField(null=True, blank=True)
...
class Estadistica(models.Model):
    ...
    res = models.CharField(max_length=1,null=True, blank=True)
    ...
    maxa = models.FloatField(null=True, blank=True)
    avgh = models.FloatField(null=True, blank=True)
    avgd = models.FloatField(null=True, blank=True)
    avga = models.FloatField(null=True, blank=True)
    def __str__(self):
